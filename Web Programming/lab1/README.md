...
![Вариант задания](./docs/images/task.png)
...
Разработанная HTML-страница и все необходимые для нее CSS и JS файлы должны быть развёрнуты на сервере Helios под управлением штатного веб-сервера и быть публично доступны.
    ...
    -При работе с CSS должно быть продемонстрировано использование селекторов идентификаторов, селекторов псевдоэлементов, селекторов дочерних элементов, селекторов атрибутов, а также такие свойства стилей CSS, как наследование и каскадирование.
...
![Результат](./docs/Отчёт_LaTex/result.png)
