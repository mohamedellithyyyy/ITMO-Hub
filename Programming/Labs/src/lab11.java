...
public class lab11 {
    ...
    final static int W_SIZE = ((arr1_ending - arr1_starting)/2)+1; // 10
    // Starting, ending and size for 1D Array№2
    final static float arr2_starting = -15;
    final static float arr2_ending = 15;
    ...
    public static void main(String[] args){
        ...
        // Print the 2nd array 
        var array2 = makeArray2(X_SIZE, arr2_starting, arr2_ending);
