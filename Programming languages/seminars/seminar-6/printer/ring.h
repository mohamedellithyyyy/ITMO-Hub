...
static struct ring_##name *ring_##name##_pushback(                        \
...
static type ring_##name##_popback(struct ring_##name **ring)              \
{                                                                     \
  if (ring == NULL)                                                   \
    return *(type *)NULL;                                             \
...
static struct ring_##name *ring_##name##_pushtop(                    \
    struct ring_##name **ring, type value)                            \
{                                                                     \
  struct ring_##name *item = ring_##name##_pushback(ring, value);         \
  if (item == NULL)                                                   \
    return NULL;                                                      \
  *ring = item;                                                       \
  return item;                                                        \
}                                                                     \
static type ring_##name##_poptop(struct ring_##name **ring)          \
{                                                                     \
  if (ring == NULL)                                                   \
    return *(type *)NULL;                                             \
  *ring = (*ring)->next;                                              \
  return ring_##name##_popback(ring);                                     \
}                                                                     \
